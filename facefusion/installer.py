...
subprocess.call([ 'pip3', 'install' , 'inquirer', '-q' ])
...
def run(program : ArgumentParser) -> None:
	...
	if answers is not None:
		...
		if torch_wheel == 'default':
			...
			subprocess.call([ 'pip3', 'install', '-r', 'requirements.txt', '--extra-index-url', 'https://download.pytorch.org/whl/' + torch_wheel ])
		subprocess.call([ 'pip3', 'uninstall', 'onnxruntime', onnxruntime_name, '-y' ])
		subprocess.call([ 'pip3', 'install', onnxruntime_name + '==' + onnxruntime_version ])
